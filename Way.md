...
2. 导论
    ...
    - foundations of computer science by Behrouz Forouzan 计算机科学导论
    - 计算机文化 。。。
...
7. 组成原理
    ...
    - systems programming and computer architecture (eth zurich) // youtube
    - 计算机组成原理
    - 计算机组成与体系结构
...
8. 操作系统 
    ...
    - 操作系统概念,silberschatz
    - 操作系统真相还原
    - David Patterson 和 John Hennessy 的原版<Computer Architecture: A Quantitative Approach> 和 <Computer Organization and Design: The Hardware/Software Interface>
